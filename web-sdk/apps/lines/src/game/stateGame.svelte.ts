...
const boardLayout = () => ({
	x: stateLayoutDerived.mainLayout().width * BOARD_ANCHOR.x,
	y: stateLayoutDerived.mainLayout().height * BOARD_ANCHOR.y,
	anchor: { x: 0.5, y: 0.5 },
...
const tumbleBoardCombined = () => {
	const combined = stateGame.tumbleBoardBase.map((tumbleReelBase, reelIndex) => {
